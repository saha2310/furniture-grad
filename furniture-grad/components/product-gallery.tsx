      ...
      <div className="flex flex-col min-w-0">
        <div className="relative aspect-square md:aspect-auto md:h-[500px] overflow-hidden bg-[#f0f0f0]">
          ...
          <Link
            ...
            className="absolute z-10 top-4 left-4 w-10 h-10 rounded-full bg-white/90 hover:bg-white flex items-center justify-center text-xl text-[#2c3e50] shadow-md transition-colors"
          >
            ‹
          </Link>
          <FavoriteButton
            productId={productId}
            className="md:hidden absolute z-10 top-4 right-4 w-10 h-10"
          />
        </div>
      </div>
    );
