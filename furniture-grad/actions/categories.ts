...
// Для админки — включая скрытые категории. Без этой функции достаточно один раз
// снять галочку "Активна" в форме редактирования, и категория пропадала бы из
// списка в админке навсегда (её просто нечем было бы показать обратно).
