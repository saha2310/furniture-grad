...
// Для виджета "подборка категорий" на главной — товары из любой из выбранных
// категорий. Раньше widget.category_ids сохранялись в базе, но нигде не
// использовались: виджет на главной показывал только картинку и название.
export async function getProductsByCategoryIds(categoryIds: string[], limit = 8) {
