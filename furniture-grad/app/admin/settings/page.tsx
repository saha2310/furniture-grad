  ...
  return (
    <div className="flex flex-col gap-10">
      <div>
        ...
        <form action={updateSettings} className="bg-white p-6 rounded-2xl shadow grid gap-5 max-w-[500px]">
          <div>
      ...
      <div>
        ...
        <form action={createContact} className="bg-white p-6 rounded-2xl shadow mb-6 grid gap-4 max-w-[500px]">
          <div>
        ...
        <div className="bg-white rounded-2xl shadow overflow-hidden max-w-[500px]">
          {contacts.length === 0 ? (
            ...
            contacts.map(c => (
              <div key={c.id} className="flex items-center justify-between p-4 border-b border-[#eee] last:border-0">
                <div>
                  <div className="font-bold text-[#2c3e50]">{c.label}</div>
                  <div className="text-sm text-[#7f8c8d]">{c.value}</div>
                </div>
